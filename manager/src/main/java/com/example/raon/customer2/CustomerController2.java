...
public class CustomerController2 {
	...
	// 請求書作成
	@PostMapping("/enroll")
	public String EnrollEmployee(@RequestParam Long id2, @RequestParam String name2, @RequestParam String address2,
	...
	public String UpdateCustomer2(@PathVariable("id2") Long id2, String name2, String address2, String phone2,
